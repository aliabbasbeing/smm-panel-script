...
$project_name            = "SmartPanel 3.4 By AbusalehInfotech- SMM panel Tool";
...
<html lang="en">
    <head>
        ...
        <meta name="author" content="abusalehinfotech">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value="FSP"  id="first_name"  name="first_name" class="form-control"  placeholder="First Name" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value="Admin"  id="last_name"  name="last_name" class="form-control"  placeholder="Last Name" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class=" col-md-9">
                                                <input type="text" value="FSP@ADMIN.COM" name="email" class="form-control" placeholder="Your email" />
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            <label for="password" class=" col-md-3">Password</label>
                                            <div class=" col-md-9">
                                                <input type="password" value="1234567890" name="password" class="form-control" placeholder="Login password"/>
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value=""  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="Find in No1scripts My shopping section" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
