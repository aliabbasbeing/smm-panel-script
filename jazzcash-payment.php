...
<html lang="en">
  ...
  <body class="bg-gray-900 text-white flex items-center justify-center min-h-screen">
    <div class="bg-gray-800 rounded-lg shadow-lg p-8 max-w-md w-full text-center">
      <img src="https://beastsmm.pk/assets/images/payments/jazzcash.png" alt="JazzCash Logo" class="mx-auto w-24 mb-4">
      ...
      <h2 class="text-yellow-400 font-extrabold text-3xl">JAZZCASH</h2>
