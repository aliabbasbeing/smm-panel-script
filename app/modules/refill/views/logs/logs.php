          ...
          <tbody>
            ...
            <tr class="tr_<?=$row->ids?>">
              ...
              <td>
                ...
                <button type="submit" class="btn round btn-success">Complete Refill</button>
                </form>
              </td>

              <td>
                <form class="form actionForm" action="<?=cn($module."/disable_refill_order/$row->ids")?>" data-redirect="<?=cn($module."/log")?>" method="POST">
                  <button type="submit" class="btn round btn-danger">Disable Refill</button>
                </form>
              </td>
            </tr>  
            <?php }}?>
