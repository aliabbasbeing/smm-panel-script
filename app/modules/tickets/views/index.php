<br>
<?php if (get_option('tickets_text','') != '') { ?>
<div class="col-sm-12 col-sm-12">
  <div class="row">
    <div class="card">
      <div class="card-body">
        <?=get_option('tickets_text','')?>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row justify-content-between">
    ...
    <div class="col-md-2">
      <div class="form-group ">
        <select  name="status" class="btn btn-info form-control order_by ajaxChange" data-url="<?=cn($module."/ajax_order_by/")?>">
