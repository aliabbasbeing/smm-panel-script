            ...
            <div class="card border-warning">
                ...
                <div class="card-body">
                    <div class="alert alert-warning" role="alert">
                        ...
                        <p>The required database tables for WhatsApp Marketing are not installed in your database.</p>
                    </div>
                    
                    <h5 class="mt-4"><i class="fe fe-tool"></i> Installation Instructions</h5>
                    <p>To enable the WhatsApp Marketing module, you need to import the database schema:</p>
                    ...
                    <div class="card bg-light mt-3">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><code>whatsapp_campaigns</code> - Store marketing campaigns</li>
                                <li><code>whatsapp_templates</code> - Store message templates</li>
                                <li><code>whatsapp_api_configs</code> - Store API configurations</li>
                                <li><code>whatsapp_recipients</code> - Store campaign recipients</li>
                                <li><code>whatsapp_logs</code> - Store activity logs</li>
                                <li><code>whatsapp_settings</code> - Store module settings</li>
                            </ul>
                        </div>
                    </div>
                    
                    <div class="alert alert-info mt-4" role="alert">
                        <i class="fe fe-info"></i> <strong>Note:</strong> After importing the database schema, refresh this page to access the WhatsApp Marketing module.
                    </div>
