              ...
              <div class="row justify-content-md-center">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control square" name="name" value="<?php echo htmlspecialchars($template->name); ?>" required>
                  </div>
                  
                  <div class="form-group">
                    <label>Description</label>
                    <textarea class="form-control square" name="description" rows="2"><?php echo htmlspecialchars($template->description); ?></textarea>
                  </div>
                  
                  <div class="form-group">
                    <label>Message <span class="text-danger">*</span></label>
                    <textarea class="form-control square" name="message" rows="8" required><?php echo htmlspecialchars($template->message); ?></textarea>
