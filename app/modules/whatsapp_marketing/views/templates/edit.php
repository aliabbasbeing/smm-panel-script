      ...
      <div class="modal-content">
        <form class="form actionForm" action="<?php echo cn($module . '/ajax_template_edit/' . $template->ids); ?>" data-redirect="<?php echo cn($module . '/templates'); ?>" method="POST">
          <div class="modal-header bg-pantone">
            <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Phone Number Template</h4>
              ...
              <div class="row justify-content-md-center">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control square" name="name" value="<?php echo htmlspecialchars($template->name); ?>" placeholder="e.g., Welcome Phone Number" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control square" name="body" id="phone_number_body" rows="15" required><?php echo htmlspecialchars($template->body); ?></textarea>
