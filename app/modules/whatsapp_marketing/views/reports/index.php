<div class="row justify-content-md-center">
  <div class="col-md-12">
    <div class="page-header">
      <h1 class="page-title">
        <i class="fe fe-bar-chart-2"></i> WhatsApp Marketing Reports
      </h1>
            ...
            <?php if(!empty($campaigns)){ 
              foreach($campaigns as $campaign){
                ...
                if($campaign->total_messages > 0){
                  $success_rate = round((($campaign->sent_messages - $campaign->failed_messages) / $campaign->total_messages) * 100, 1);
                }
                
                $open_rate = 0;
                if($campaign->sent_messages > 0){
                  $open_rate = round(($campaign->delivered_messages / $campaign->sent_messages) * 100, 1);
                }
            ?>
            <tr>
              <td>
              ...
              <td><?php echo number_format($campaign->total_messages); ?></td>
              <td><span class="text-success"><?php echo number_format($campaign->sent_messages); ?></span></td>
              <td><span class="text-info"><?php echo number_format($campaign->delivered_messages); ?></span></td>
              <td><span class="text-danger"><?php echo number_format($campaign->failed_messages); ?></span></td>
              <td>
                <div class="clearfix">
...
<!-- Phone Number Statistics Breakdown -->
<div class="row mt-4">
  <div class="col-md-6">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Phone Number Delivery Statistics</h3>
      </div>
      <div class="card-body">
        <div class="row mb-3">
          <div class="col-6">
            <div class="text-muted">Total Phone Numbers</div>
            <div class="h3"><?php echo number_format($stats->total_messages); ?></div>
          </div>
          <div class="col-6">
        ...
        <div class="mb-3">
          <div class="clearfix">
            <div class="float-left"><strong>Sent Phone Numbers</strong></div>
            <div class="float-right"><small class="text-muted"><?php echo number_format($stats->total_sent); ?></small></div>
          </div>
          <div class="progress progress-sm">
            <div class="progress-bar bg-success" style="width: <?php echo $stats->total_messages > 0 ? round(($stats->total_sent / $stats->total_messages) * 100) : 0; ?>%"></div>
          </div>
        </div>
        
        <div class="mb-3">
          <div class="clearfix">
            <div class="float-left"><strong>Pending Phone Numbers</strong></div>
            <div class="float-right"><small class="text-muted"><?php echo number_format($stats->total_remaining); ?></small></div>
          </div>
          <div class="progress progress-sm">
            <div class="progress-bar bg-primary" style="width: <?php echo $stats->total_messages > 0 ? round(($stats->total_remaining / $stats->total_messages) * 100) : 0; ?>%"></div>
          </div>
        </div>
        
        <div class="mb-3">
          <div class="clearfix">
            <div class="float-left"><strong>Failed Phone Numbers</strong></div>
            <div class="float-right"><small class="text-muted"><?php echo number_format($stats->total_failed); ?></small></div>
          </div>
          <div class="progress progress-sm">
            <div class="progress-bar bg-danger" style="width: <?php echo $stats->total_messages > 0 ? round(($stats->total_failed / $stats->total_messages) * 100) : 0; ?>%"></div>
          </div>
        </div>
        
        <div class="mb-0">
          <div class="clearfix">
            <div class="float-left"><strong>Delivered Phone Numbers</strong></div>
            <div class="float-right"><small class="text-muted"><?php echo number_format($stats->total_delivered); ?></small></div>
          </div>
          <div class="progress progress-sm">
            <div class="progress-bar bg-info" style="width: <?php echo $stats->total_sent > 0 ? round(($stats->total_delivered / $stats->total_sent) * 100) : 0; ?>%"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <ul>
          <li>View real-time statistics (sent, delivered, failed, read)</li>
          ...
          <li>Resend failed messages individually or in bulk</li>
        </ul>
