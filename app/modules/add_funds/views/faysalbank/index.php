<style>
    /* Unique styles for Faysal Bank language toggle */
    .fblang-btn {
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          <img src="/assets/images/payments/faysal-bank.png" alt="Faysal Bank" width="90%">
          <p class="p-t-10">
            <small>You can deposit funds with Faysal Bank and they will be automatically added into your account within 1 hour!</small>
          </p>
        </div>

        <!-- Language Toggle Buttons (Faysal Bank only) -->
        <div style="text-align: right; margin-bottom: 10px;">
          <button type="button" onclick="toggleFbLanguage('urdu')" class="fblang-btn active" id="fb-btn-urdu">اردو</button>
          <button type="button" onclick="toggleFbLanguage('english')" class="fblang-btn" id="fb-btn-english">English</button>
        </div>

        <!-- Urdu Instructions (Default) -->
        <div id="fb-instructions-urdu" class="instruction-box urdu-rtl">
          <h5 style="text-align: right;">ادائیگی کے مراحل:</h5>
          <ol>
            <li>اوپر دیا گیا فیسل بینک اکاؤنٹ نمبر کاپی کریں۔</li>
            <li>اپنی انٹرنیٹ بینکنگ یا فیسل بینک ایپ میں لاگ ان کریں اور رقم منتقل کریں۔</li>
            <li>اس فارم میں واپس آ کر ٹرانزیکشن آئی ڈی اور بھیجی گئی رقم درج کریں، پھر سبمٹ پر کلک کریں۔</li>
          </ol>
        </div>

        <!-- English Instructions -->
        <div id="fb-instructions-english" class="instruction-box" style="display:none;">
          <h5>Payment Steps:</h5>
          <ol>
            <li>Copy the Faysal Bank account number shown above.</li>
            <li>Login to your internet banking or Faysal Bank app and transfer the amount.</li>
...
<script>
function toggleFbLanguage(lang) {
    const urdu = document.getElementById('fb-instructions-urdu');
    const english = document.getElementById('fb-instructions-english');
    const btnUrdu = document.getElementById('fb-btn-urdu');
    const btnEnglish = document.getElementById('fb-btn-english');
