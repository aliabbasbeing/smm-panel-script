    <div class="sidebar o-auto">
      ...
      <div class="list-group list-group-transparent mb-0">
        ...
        <a href="<?php echo cn($module."/modules")?>" class="list-group-item list-group-item-action <?php echo (segment(2) == 'modules') ? 'active' : ''?>"><span class="icon mr-3"><i class="fa fa-question-circle"></i></span><?=lang("Modules")?></a>

        <a href="<?php echo cn($module."/pages")?>" class="list-group-item list-group-item-action <?php echo (segment(2) == 'pages') ? 'active' : ''?>"><span class="icon mr-3"><i class="fe fe-book"></i></span>Pages & Text</a>

        <a href="<?php echo cn($module."/rules_updates")?>" class="list-group-item list-group-item-action <?php echo (segment(2) == 'rules_updates') ? 'active' : ''?>"><span class="icon mr-3"><i class="fa fa-info-circle"></i></span>Rules & Updates</a>
      ...
      <div class="list-group list-group-transparent mb-0">
        ...
        <a href="<?php echo cn($module."/whatsapp_notifications")?>" class="list-group-item list-group-item-action <?php echo (segment(2) == 'whatsapp_notifications') ? 'active' : ''?>"><span class="icon mr-3"><i class="fa fa-whatsapp"></i></span>WhatsApp Notifications</a>
      </div>
