   <div class="card p-0 content">
    ...
    <div class="form-group">
        <label class="form-label">Image URL for Modal</label>
        <input type="text" class="form-control" name="vertical_image_modal_url" id="vertical_image_modal_url"
               value="<?= get_option('vertical_image_modal_url', 'https://i.ibb.co/8LZvrpDK/file-000000006374622f80e6350155d31b37.png') ?>"
               placeholder="Paste image URL here">
        <?php if(get_option('vertical_image_modal_url', '')): ?>
            <div style="margin-top:10px;">
                <img src="<?= get_option('vertical_image_modal_url', 'https://i.ibb.co/8LZvrpDK/file-000000006374622f80e6350155d31b37.png') ?>"
                     style="max-width:90px; max-height:160px; border:1px solid #ccc;">
            </div>
        <?php endif; ?>
    </div>
</div>
