   ...
   <div class="card p-0 content">
      <div class="card-header">
        <h3 class="card-title" style="color:#fff !important;"><i class="fe fe-sliders"></i> <?=lang("other_settings")?></h3>
      </div>
      <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                   <label class="form-label"><?=lang("Contect_Number")?></label>
                    <input class="form-control" name="contect_number" value="<?=get_option('contect_number',"+12345678")?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
