              ...
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control square" name="payment_params[number]" value="<?php echo (!empty($payment->number))? $payment->number : '' ; ?>">
                  </div>
                </div>
               ...
               <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control square" name="payment_params[holder]" value="<?php echo (!empty($payment->holder))? $payment->holder : '' ; ?>">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control text-end" name="payment_params[option][rate_to_usd]" value="<?php echo (isset($option->rate_to_usd)) ? $option->rate_to_usd : 168; ?>">
                      <span class="">
                  ...
                  <div class="form-group">
                    ...
                    <ul>
                      <li>you have need to accept Transaction from admin setting</li>
                      <li>put your account details</li>
                      <li>Copy <strong>Manually</strong> check <strong>transaction</strong> and Save</li>
                    </ul>
                  </div>
                </div>
