            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">IMAP Host <small>(e.g. {mail.yourdomain.pk:993/imap/ssl/novalidate-cert}INBOX)</small></label>
                    ...
                    <div class="form-group">
                      ...
                      <ul class="small">
                        <li>
                          ...
                          Example for Host: <code>{mail.yourdomain.pk:993/imap/ssl/novalidate-cert}INBOX</code>
                        </li>
                        <li>
                          JazzCash transaction verification will use your own email's IMAP, not Gmail.
                        </li>
                        <li>
