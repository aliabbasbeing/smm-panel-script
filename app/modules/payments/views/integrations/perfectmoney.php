            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">USD wallets (USD)<span class="form-required">*</span></label>
                    <input type="text" class="form-control" name="payment_params[option][usd_wallet]" value="<?php echo (isset($option->usd_wallet)) ? $option->usd_wallet : ''; ?>">
                  </div>

                  <div class="form-group">
                    <label class="form-label">Alternate Passphrase<span class="form-required">*</span></label>
                    <input type="text" class="form-control" name="payment_params[option][alternate_pass]" value="<?php echo (isset($option->alternate_pass)) ? $option->alternate_pass : ''; ?>">
                  </div>
