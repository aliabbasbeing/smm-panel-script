            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">Paytm MID (Merchant ID)<span class="form-required">*</span></label>
                    <input type="text" class="form-control" name="payment_params[option][paytm_mid]" value="<?php echo (isset($option->paytm_mid)) ? $option->paytm_mid : ''; ?>">
                  </div>

                  <div class="form-group">
                    <label class="form-label">Paytm Merchant Key<span class="form-required">*</span></label>
