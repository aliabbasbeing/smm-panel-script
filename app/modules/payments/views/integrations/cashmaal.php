            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  <hr>
                  <div class="form-group">
                    <label class="form-label">Cashmaal Web ID<span class="form-required">*</span></label>
                  ...
                  <div class="form-group">
                    <label class="form-label">Cashmaal IPN KEY<span class="form-required">*</span></label>
                    <input type="text" class="form-control" name="payment_params[option][ipn_key]" value="<?php echo (isset($option->ipn_key)) ? $option->ipn_key : ''; ?>">
                  </div>
