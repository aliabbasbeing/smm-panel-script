      ...
      <div class="table-responsive">
        <table class="table table-hover table-bordered table-vcenter card-table">
          ...
          <tbody>
            ...
            <?php 
            if ($currency == 1) {
              $charge_show = $row->charge/76;
            } else {
              $charge_show = $row->charge;
            }
            ?>
                ...
                <div>
                  <small>
                    <ul style="margin:0px">
                      ...
                      <li><?=lang("Amount") ?>: <?php echo $sign_convert; ?><?= (!empty($charge_show)) ? currency_format($charge_show, get_option('currency_decimal', 2), $decimalpoint, $separator) : 0 ?></li>
