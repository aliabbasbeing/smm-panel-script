  ...
  <div class="modal-right">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <form class="form actionForm" action="<?=cn($module."/ajax_add")?>" method="POST">
          <div class="modal-header bg-pantone">
            <h4 class="modal-title"><i class="fa fa-plus"></i> <?=lang("add_new_service")?></h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            </button>
          </div>
          <div class="modal-body">
            <div class="form-body" id="add_new_service_form">
              <div class="row justify-content-md-center">
                ...
                <!-- API mode -->
                <div class="col-md-12 service-type-add d-none">
                ...
                <!-- Manual Mode -->
                <div class="col-md-12 service-manual-type-add">
                  <fieldset class="form-fieldset">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
...
<script>
  // Check post type for Add Service modal
  $(document).on("change","#add_new_service_form input[type=radio][name=add_type]", function(){
    _that = $(this);
    _type = _that.val();
    if(_type == 'api'){
      $('.service-type-add').removeClass('d-none');
      $('.service-manual-type-add').addClass('d-none');
    }else{
      $('.service-manual-type-add').removeClass('d-none');
      $('.service-type-add').addClass('d-none');
    }
  });
  ...
  $(document).on("change", "#add_new_service_form .ajaxGetServiceDetail", function(){
    
    $(".api-service-details-add input[name=original_price]").val('');
    $("#add_new_service_form input[name=min]").val('');
    $("#add_new_service_form input[name=max]").val('');
    ...
    $("#add_new_service_form input[name=min]").val(_min);
    $("#add_new_service_form input[name=max]").val(_max);
  })
</script>
