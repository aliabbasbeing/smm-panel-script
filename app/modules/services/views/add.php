...
<script>
  ...
  $(document).off("change", "#add_service_form input[type=radio][name=add_type]");
  ...
  $(document).off("change", ".ajaxGetServicesFromAPIAdd");
  ...
  $(document).off("change", "#add_service_form .ajaxGetServiceDetail");
  ...
  $(document).off("change", ".ajaxChangeServiceTypeAdd");
