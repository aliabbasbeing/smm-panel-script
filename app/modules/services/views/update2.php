                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-controls-stacked">
                      <label class="form-check custom-control-inline">
                        <input type="radio" class="form-check-input" name="add_type" value="manual" <?=(isset($service->add_type) && $service->add_type == 'api')? '': 'checked'?>>
                        <span class="form-check-label"><?=lang('Manual')?></span>
                      </label>
                      <label class="form-check custom-control-inline">
                        <input type="radio" class="form-check-input" name="add_type" value="api" <?=(isset($service->add_type) && $service->add_type == 'api')? 'checked': ''?>>
                        <span class="form-check-label"><?=lang('API')?></span>
                      </label>
                    </div>
                  </div>
                </div>
