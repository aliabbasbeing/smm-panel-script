    ...
    <div class="row justify-content-between">
      <div class="col-md-2">
        <h1 class="page-title">
          ...
          ?>
          <a href="<?=cn("$module/add")?>"><span class="add-new" data-toggle="tooltip" data-placement="bottom" title="<?=lang("add_new_service")?>" data-original-title="Add new"><i class="btn btn-info fa fa-plus"> <?=lang("add_new")?></i></span></a>
          <?php }else{?>
