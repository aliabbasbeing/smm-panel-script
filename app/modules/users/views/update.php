              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input class="form-control square" name="email" type="email" <?php echo (!empty($user->email))? 'disabled': ''?> value="<?php echo (!empty($user->email))? htmlspecialchars($user->email): ''?>">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
  <div class="form-group">
    <label for="projectinput5"><?php echo lang("WhatsApp Number"); ?></label>
    <input class="form-control square" name="whatsapp_number" type="text" value="<?php echo (!empty($user->whatsapp_number)) ? htmlspecialchars($user->whatsapp_number) : ''; ?>">
  </div>
</div>
