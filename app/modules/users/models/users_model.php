...
// In your model
public function get_total_orders_by_user_id($user_id) {
    return $this->db->where('uid', $user_id) // Assuming 'uid' is the user identifier in the 'orders' table
                    ->count_all_results('orders'); // Returns the count of orders for this user
}
