...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href="<?=asset_url('assets/css/landing_page.css')?>" rel="stylesheet">
  ...
  <body class="">
    ...
    <script src="<?=asset_url('assets/plugins/particles-js/particles.js')?>"></script>
    <script src="<?=asset_url('assets/plugins/particles-js/app.js')?>"></script>
    <script src="<?=asset_url('assets/plugins/particles-js/stats.js')?>"></script>
