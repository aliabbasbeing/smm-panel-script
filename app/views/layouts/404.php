			...
			<div class="row justify-content-md-center">
				<div class="col-md-5">
					...
					<div class="content">
						...
						<div class="go-back">
			              <a href="<?php echo $base_url; ?>" class="btn btn-pill btn-gradient btn-go-home btn-min-width me-1 mb-1"><span><i class="fe fe-arrow-left"></i></span> BBack to Home Page</a>
			            </div>
					</div>
				</div>
			</div>
