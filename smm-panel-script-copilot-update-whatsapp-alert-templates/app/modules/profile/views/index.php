...
<div class="row">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form class="form actionForm" action="<?= cn($module . "/ajax_update_whatsapp_number") ?>" data-redirect="<?= cn($module) ?>" method="POST">
        <div class="form-body">
          <div class="row">
            <?php
              // Assuming the user WhatsApp number is already fetched
              $whatsapp_number = (!empty($user->whatsapp_number)) ? $user->whatsapp_number : '';
            ?>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="whatsapp_number"><?= lang('WhatsApp Number') ?></label>
                <input class="form-control square" name="whatsapp_number" type="text" value="<?= $whatsapp_number ?>" placeholder="<?= lang('Enter your WhatsApp number') ?>" required>
                <small class="text-primary"><?= lang('Please_enter_a_valid_WhatsApp_number') ?></small>
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12 form-actions left">
              <div class="p-l-10">
